...
// }
// 
// GIODevice::IOResult GSocket::write(const void* pData, size_t size)
// {
// 	if (isClosed())
// 		return GIODevice::IO_NotOpen;
// 	if (m_async)
// 	{
// 		
// 	}
...
// }
// 
// GIODevice::IOResult GSocket::read(void* pData, size_t size, size_t* readsize /*= nullptr*/)
// {
// 	if (isClosed())
// 		return GIODevice::IO_NotOpen;
// 
